...
{
	{
		...
		*C = *D;
		C->setBrain("I HAVE IDEA", 99);
		D->setBrain("I HAVE IDEA FOR DEEP COPY", 99);

		std::cout << C->getBrain(99) << std::endl;
		std::cout << D->getBrain(99) << std::endl;

		delete C;
		delete D;
		std::cout << "end test deep copy" << std::endl;
